...
namespace thts {
     ...
     *      actions: 
     *          A list of valid actions that can be used at this node
     *      policy_prior: 
     *          A prior policy for this state (if we have one)
     *      psuedo_q_value_offset: 
     *          An offset to use for any psuedo q values set from a policy prior
     */
