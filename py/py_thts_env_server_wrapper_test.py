...
def server_worker(thts_env, rpc_conn):
    """
    ...
    while True:
        try:
            ...
            # things called less often
                ...
                rpc_conn.send(thts_env.get_initial_state())
...
class PyThtsEnvServerWrapper(PyThtsEnv):
    ...
    def __init__(self, env):
        ...
        self.server_process = Process(target=server_worker, args=(env,rpc_conn))
    ...
    def clone(self):
        ...
        new_env_wrapper.server_conn, rpc_conn = Pipe()
        new_env_wrapper.server_process = Process(target=server_worker, args=(env,rpc_conn))
        senew_env_wrapperlf.server_process.start()
