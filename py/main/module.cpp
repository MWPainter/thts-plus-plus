...
void chmcts_test() {
    ...
    // Make thts manager 
    shared_ptr<ChCztManagerArgs> args = make_shared<ChCztManagerArgs>(thts_env);
    args->seed = 60415;
    args->max_depth = walk_len * 4;
    args->mcts_mode = false;
    args->bias = bias;
...
//     shared_ptr<SmBtsManagerArgs> sargs = make_shared<SmBtsManagerArgs>(thts_env_bts, default_val);
//     sargs->seed = 60415;
...
//     shared_ptr<SmBtsManager> smanager = make_shared<SmBtsManager>(*sargs);
...
//     shared_ptr<SmBtsDNode> sroot_node = make_shared<SmBtsDNode>(smanager, init_state, 0, 0);
...
//         shared_ptr<SmBtsDNode> cur_bts_node = sroot_node;
...
//                         continue;
//                     }
//                     shared_ptr<SmBtsCNode> child_node = cur_bts_node->get_child_node(action);
...
//             shared_ptr<SmBtsCNode> c_bts_node = cur_bts_node->get_child_node(bts_action);
