...
/**
 * GilReenterantLockGuardwas was useful when just using pybind
 * But ultimately GIL was still a problem
 * And turns out sub-interpreters gets around the issues
 * As long as we protect python objects with C++ locks
*/
