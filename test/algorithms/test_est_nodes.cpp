...
TEST(Est_GraphSearch_IntegrationTest, easy_grid_world) {
    run_est_integration_test(1, 1, 10000, 0.0, 2, 1.0, false, true);
}

TEST(Est_GraphSearch_IntegrationTest, easy_grid_world_multithreaded) {
    run_est_integration_test(2, 4, 10000, 0.0, 1, 0.5, false, true);
}

TEST(Est_GraphSearch_IntegrationTest, easy_grid_world_stochastic) {
    run_est_integration_test(1, 1, 10000, 0.1, 2, 1.0, false, true);
}

TEST(Est_GraphSearch_IntegrationTest, easy_grid_world_stochastic_multithreaded) {
    run_est_integration_test(2, 4, 10000, 0.1, 1, 0.5, false, true);
}
