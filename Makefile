...
GO_CUDA_LDFLAGS = -lcudart -lcudnn -lcublas 
GO_TENSORRT_LDFLAGS = -lnvinfer
GO_LDFLAGS = -L/opt/local/lib -L /usr/local/cuda-11.7/lib64/ -L/usr/local/cuda/lib64/ -lzip -lz $(GO_CUDA_LDFLAGS) #$(GO_TENSORRT_LDFLAGS)
