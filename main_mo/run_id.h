...
// env ids - toy/tree
static const std::string TOY_TREE_DENSE_ENV_ID = "toy_tree_dense";
static const std::string TOY_TREE_SPARSE_ENV_ID = "toy_tree_sparse";

static const std::unordered_set<std::string> TOY_ENVS =
{
    TOY_TREE_DENSE_ENV_ID,
    TOY_TREE_SPARSE_ENV_ID
};
...
static const std::string EVAL_TOY_DENSE_DIMENSION_SCALABILITY_EXPR_ID = "200_dense_dimension_scalability";
static const std::string EVAL_TOY_DENSE_ACTIONS_SCALABILITY_EXPR_ID = "210_dense_actions_scalability";
static const std::string EVAL_TOY_SPARSE_DIMENSION_SCALABILITY_EXPR_ID = "250_sparse_dimension_scalability";
static const std::string EVAL_TOY_SPARSE_ACTIONS_SCALABILITY_EXPR_ID = "260_sparse_actions_scalability";
...
static const std::string EVAL_DST_STOCH_EXPR_ID = "610_deep_sea_treasure_stoch";
static const std::string EVAL_FT_EXPR_ID = "640_fruit_tree";
static const std::string EVAL_FT_S5_EXPR_ID = "650_fruit_tree_stoch_5";
...
static const std::unordered_set<std::string> ALL_EXPR_IDS = 
{
    ...
    EVAL_TOY_DENSE_DIMENSION_SCALABILITY_EXPR_ID,
    EVAL_TOY_DENSE_ACTIONS_SCALABILITY_EXPR_ID,
    EVAL_TOY_SPARSE_DIMENSION_SCALABILITY_EXPR_ID,
    EVAL_TOY_SPARSE_ACTIONS_SCALABILITY_EXPR_ID,
