...
static const std::vector<ConfigMap> CONFIG_004 =
{
    // xpr params
    {
        {XPR_OR_ALG_ID_TAG,                             XPR_PARAMS_ID_TAG},
        {XPR_PARAM_ID_NAME,                             "004_debug"},
        ...
        {XPR_PARAM_ID_RUNTIME_BOUNDED,                  false}, // iters not runtime for chvi test
        {XPR_PARAM_ID_TERMINATION_BOUND,                30.0}, // 30 iter
