...
static const std::vector<ConfigMap> CONFIG_590 =
{
    // xpr params
    {
        {XPR_OR_ALG_ID_TAG,                             XPR_PARAMS_ID_TAG},
        {XPR_PARAM_ID_NAME,                             "590_resource_gather_timed_cpp"},
        {XPR_PARAM_ID_ENV,                              ENV_ID_RESOURCE_GATHER_TIMED_CPP},
