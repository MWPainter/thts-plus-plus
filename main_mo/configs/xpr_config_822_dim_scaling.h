...
static const std::vector<ConfigMap> CONFIG_822 =
{
    // xpr params
    {
        {XPR_OR_ALG_ID_TAG,                             XPR_PARAMS_ID_TAG},
        {XPR_PARAM_ID_NAME,                             "822_reward_dim_scaling_change_sm_params"},
        ...
        // try larger min simplex radius + smaller push radius to bump num backups
