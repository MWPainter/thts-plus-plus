# variables 
EXPR_ID="x00a_bts_tune_temp_no_decay"
...
do
    ...
    do
        ...
        then
            ...
            sbatch --job-name=0a:${AGENT_ONE_ID}vs${AGENT_TWO_ID} --output=$OUTFILE --export=EXPR_ID=$EXPR_ID,AGENT_ONE_ID=$AGENT_ONE_ID,AGENT_TWO_ID=$AGENT_TWO_ID run_go.slurm
        fi
    done
done