# variables 
EXPR_ID="w001_bts_tune_temp_sqrt_decay"
...
do
    ...
    do
        ...
        then
            ...
            sbatch --job-name=w01:${AGENT_ONE_ID}vs${AGENT_TWO_ID} --output=$OUTFILE --export=EXPR_ID=$EXPR_ID,AGENT_ONE_ID=$AGENT_ONE_ID,AGENT_TWO_ID=$AGENT_TWO_ID run_go.slurm
        fi
    done
done