# variables 
EXPR_ID="101a_round_robin_with_dirichlet_9x9"

num_fixup=10
agent_one_ids=("kata" "kata" "kata" "kata" "kata" "tents" "ments" "est" "dents" "rents")
agent_two_ids=("est" "dents" "rents" "ments" "tents" "kata" "kata" "kata" "kata" "kata")
