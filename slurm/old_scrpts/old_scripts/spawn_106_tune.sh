# variables 
EXPR_ID="106_tune_decayed_temp_visits_scale_dents"
...
do
    ...
    do
        ...
        then
            ...
            sbatch --job-name=106:${AGENT_ONE_ID}vs${AGENT_TWO_ID} --output=$OUTFILE --export=EXPR_ID=$EXPR_ID,AGENT_ONE_ID=$AGENT_ONE_ID,AGENT_TWO_ID=$AGENT_TWO_ID run_go.slurm
        fi
    done
done