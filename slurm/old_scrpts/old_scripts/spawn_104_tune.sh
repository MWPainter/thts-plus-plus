# variables 
EXPR_ID="104_tune_eps"

# temps=("0.03" "0.01" "0.003" "0.001" "0.0003" "0.00003")
temps=("0.3" "0.1" "0.03" "0.01" "0.003" "0.001")
...
do
    ...
    do
        ...
        then
            ...
            sbatch --job-name=104:${AGENT_ONE_ID}vs${AGENT_TWO_ID} --output=$OUTFILE --export=EXPR_ID=$EXPR_ID,AGENT_ONE_ID=$AGENT_ONE_ID,AGENT_TWO_ID=$AGENT_TWO_ID run_go.slurm
        fi
    done
done