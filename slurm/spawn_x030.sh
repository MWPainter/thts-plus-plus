# variables 
EXPR_ID="x030_bts_tune_eps_coeff"
...
do
    ...
    do
        ...
        then
            ...
            sbatch --job-name=x30:${AGENT_ONE_ID}vs${AGENT_TWO_ID} --output=$OUTFILE --export=EXPR_ID=$EXPR_ID,AGENT_ONE_ID=$AGENT_ONE_ID,AGENT_TWO_ID=$AGENT_TWO_ID run_go.slurm
        fi
    done
done