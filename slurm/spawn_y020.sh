# variables 
EXPR_ID="y020_ar_round_robin_with_rand"
...
do
    ...
    do
        ...
        then
            ...
            sbatch --job-name=y20:${AGENT_ONE_ID}vs${AGENT_TWO_ID} --output=$OUTFILE --export=EXPR_ID=$EXPR_ID,AGENT_ONE_ID=$AGENT_ONE_ID,AGENT_TWO_ID=$AGENT_TWO_ID run_go.slurm
        fi
    done
done