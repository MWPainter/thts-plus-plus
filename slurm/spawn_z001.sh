# variables 
EXPR_ID="z001_ar_bts_vs_kata_native"
...
do
    ...
    do
        ...
        then
            ...
            sbatch --job-name=z01:${AGENT_ONE_ID}vs${AGENT_TWO_ID} --output=$OUTFILE --export=EXPR_ID=$EXPR_ID,AGENT_ONE_ID=$AGENT_ONE_ID,AGENT_TWO_ID=$AGENT_TWO_ID run_go.slurm
        fi
    done
done