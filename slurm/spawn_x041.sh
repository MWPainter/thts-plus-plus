# variables 
EXPR_ID="x041_ments_tune_temp_most_visit"
...
do
    ...
    do
        ...
        then
            ...
            sbatch --job-name=x41:${AGENT_ONE_ID}vs${AGENT_TWO_ID} --output=$OUTFILE --export=EXPR_ID=$EXPR_ID,AGENT_ONE_ID=$AGENT_ONE_ID,AGENT_TWO_ID=$AGENT_TWO_ID run_go.slurm
        fi
    done
done
done