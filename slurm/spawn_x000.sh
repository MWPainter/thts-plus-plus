# variables 
EXPR_ID="x000_bts_tune_temp_no_decay"
...
do
    ...
    do
        ...
        then
            ...
            sbatch --job-name=x00:${AGENT_ONE_ID}vs${AGENT_TWO_ID} --output=$OUTFILE --export=EXPR_ID=$EXPR_ID,AGENT_ONE_ID=$AGENT_ONE_ID,AGENT_TWO_ID=$AGENT_TWO_ID run_go.slurm
        fi
    done
done