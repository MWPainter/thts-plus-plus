# variables 
EXPR_ID="w070_dents_tune_value_temp"
...
do
    ...
    do
        ...
        then
            ...
            sbatch --job-name=w70:${AGENT_ONE_ID}vs${AGENT_TWO_ID} --output=$OUTFILE --export=EXPR_ID=$EXPR_ID,AGENT_ONE_ID=$AGENT_ONE_ID,AGENT_TWO_ID=$AGENT_TWO_ID run_go.slurm
        fi
    done
done