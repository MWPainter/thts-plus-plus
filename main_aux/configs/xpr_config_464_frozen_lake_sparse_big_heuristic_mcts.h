...
static const std::vector<ConfigMap> CONFIG_464 =
{
    // xpr params
    {
        {XPR_OR_ALG_ID_TAG,                     XPR_PARAMS_ID_TAG},
        {XPR_PARAM_ID_NAME,                     "464_eval_frozen_lake_sparse_8x24_heuristic_mcts"},
        {XPR_PARAM_ID_ENV,                      ENV_ID_FROZEN_LAKE_S_8x24},
