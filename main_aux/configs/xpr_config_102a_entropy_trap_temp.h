...
static const std::vector<ConfigMap> CONFIG_102a =
{
    // xpr params
    {
        {XPR_OR_ALG_ID_TAG,                     XPR_PARAMS_ID_TAG},
        {XPR_PARAM_ID_NAME,                     "102a_supp_entropy_temp_10_vary"},
        ...
        {XPR_PARAM_ID_TERMINATION_BOUND,        50000.0}, // 10x number of trials
