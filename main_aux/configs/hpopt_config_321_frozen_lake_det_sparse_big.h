...
static const std::vector<HpoptConfigMap> HPOPT_CONFIG_321 =
{
    // xpr params
    {
        {XPR_OR_ALG_ID_TAG,                             HPOPT_PARAMS_ID_TAG},
        {XPR_PARAM_ID_NAME,                             "321_hpopt_frozen_lake_det_sparse_big_heuristic_weight_local_0.0"},
        {XPR_PARAM_ID_ENV,                              ENV_ID_FROZEN_LAKE_S_12x12},
        ...
        {HPOPT_PARAM_ID_BAYESOPT_USE_GPML,              0}, // lots of 0 values gives nlopt failures and kills program
    },
    // uct params
    {
