...
static const std::vector<ConfigMap> CONFIG_401c =
{
    // xpr params
    {
        {XPR_OR_ALG_ID_TAG,                     XPR_PARAMS_ID_TAG},
        {XPR_PARAM_ID_NAME,                     "401c_eval_frozen_lake_dense_8x16"},
    ...
    // rents params: -20.8
    {
        ...
        {ALG_PARAM_ID_EPSILON,          1.0},
        {ALG_PARAM_ID_HEURISTIC_VALUE,  0.0},// {ALG_PARAM_ID_HEURISTIC_VALUE,  -83.5272},
    },
    // rents params: -20.8
    {
        {XPR_OR_ALG_ID_TAG,             ALG_ID_RENTS},
