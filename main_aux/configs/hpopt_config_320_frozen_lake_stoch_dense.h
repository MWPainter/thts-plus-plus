// // Skipping this on re-runs, from the original HPOPT can see that the rewards are like -70
// // This is because you get like a -100 reward for hole
// // Best policy only has a 55% chance of not slipping into hole
// // Then takes like 10ish steps to actually get to goal
// // But value of -70 isn't very human friendly
// // If set hold reward to -200, then it would be reward of -170
// // That is, value depends more on the hole reward than the policy
// // Whereas sparse reward has an obvious interpretaion of Pr(reach goal)
...
//         {HPOPT_PARAM_ID_ESTIMATE_CONFIDENCE_THRESHOLD,  0.3},
