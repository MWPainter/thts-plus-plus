...
static const std::vector<HpoptConfigMap> HPOPT_CONFIG_360 =
{
    // xpr params
    {
        {XPR_OR_ALG_ID_TAG,                             HPOPT_PARAMS_ID_TAG},
        {XPR_PARAM_ID_NAME,                             "360_hpopt_frozen_lake_det_sparse_mcts"},
        ...
        {XPR_PARAM_ID_TERMINATION_BOUND,                25000},
        // {XPR_PARAM_ID_REPEATED_RUNS_PER_ALG,            2},
        {XPR_PARAM_ID_SEARCH_THREADS,                   16},
        {XPR_PARAM_ID_EVAL_DELTA,                       25000},
