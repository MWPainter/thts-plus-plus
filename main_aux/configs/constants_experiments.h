...
static const std::string XPR_PARAM_ID_HEURISTIC_WEIGHT_GLOBAL = "heuristic_weight_global"; // global heuristic weight
static const std::string XPR_PARAM_ID_HEURISTIC_WEIGHT_LOCAL = "heuristic_weight_local"; // local heuristic weight
