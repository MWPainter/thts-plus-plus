...
static const std::vector<ConfigMap> CONFIG_471 =
{
    // xpr params
    {
        {XPR_OR_ALG_ID_TAG,                     XPR_PARAMS_ID_TAG},
        {XPR_PARAM_ID_NAME,                     "471_eval_frozen_lake_sparse_8x12_heuristic_mcts_graph"},
        {XPR_PARAM_ID_ENV,                      ENV_ID_FROZEN_LAKE_S_8x12},
        ...
        {XPR_PARAM_ID_TERMINATION_BOUND,        1000000}, //500000},
