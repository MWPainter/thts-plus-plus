...
static const std::vector<ConfigMap> CONFIG_110 =
{
    // xpr params
    {
        {XPR_OR_ALG_ID_TAG,                     XPR_PARAMS_ID_TAG},
        {XPR_PARAM_ID_NAME,                     "110_supp_dchain_temp_vary"},
    ...
    },
    {
        ...
        {ALG_PARAM_ID_EPSILON,          0.01},
        {ALG_PARAM_ID_HEURISTIC_VALUE,  0.0},
        {ALG_PARAM_ID_INIT_ENTROPY_COEFF,       0.18},
        {ALG_PARAM_ID_ENTROPY_COEFF_ZERO_AT,    1.0e12},
        // {ALG_PARAM_ID_NORMALISE_Q,      0}, // manually hacked in for this xpr
    },
    {
        ...
        {ALG_PARAM_ID_EPSILON,          0.01},
        {ALG_PARAM_ID_HEURISTIC_VALUE,  0.0},
        {ALG_PARAM_ID_INIT_ENTROPY_COEFF,       0.32},
        {ALG_PARAM_ID_ENTROPY_COEFF_ZERO_AT,    1.0e12},
        // {ALG_PARAM_ID_NORMALISE_Q,      0}, // manually hacked in for this xpr
    },
    {
        ...
        {ALG_PARAM_ID_EPSILON,          0.01},
        {ALG_PARAM_ID_HEURISTIC_VALUE,  0.0},
        {ALG_PARAM_ID_INIT_ENTROPY_COEFF,       0.58},
        {ALG_PARAM_ID_ENTROPY_COEFF_ZERO_AT,    1.0e12},
        // {ALG_PARAM_ID_NORMALISE_Q,      0}, // manually hacked in for this xpr
    },
    {
