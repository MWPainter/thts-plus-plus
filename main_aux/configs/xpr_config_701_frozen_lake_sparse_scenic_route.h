...
static const std::vector<ConfigMap> CONFIG_701 =
{
    // xpr params
    {
        ...
        {XPR_PARAM_ID_NAME,                     "701_supp_frozen_lake_sparse_scenic_route_8x12"},
    ...
    // range of uct params
    {
        ...
        {ALG_PARAM_ID_BIAS,        0.00001},
        {ALG_PARAM_ID_HEURISTIC_VALUE,  0.0},
    },
    {
        {XPR_OR_ALG_ID_TAG,             ALG_ID_UCT},
        {ALG_PARAM_ID_BIAS,        0.00003},
        {ALG_PARAM_ID_HEURISTIC_VALUE,  0.0},
    },
    {
        {XPR_OR_ALG_ID_TAG,             ALG_ID_UCT},
        {ALG_PARAM_ID_BIAS,        0.0001},
        {ALG_PARAM_ID_HEURISTIC_VALUE,  0.0},
    },
    {
        {XPR_OR_ALG_ID_TAG,             ALG_ID_UCT},
        {ALG_PARAM_ID_BIAS,        0.0003},
        {ALG_PARAM_ID_HEURISTIC_VALUE,  0.0},
    },
    {
        {XPR_OR_ALG_ID_TAG,             ALG_ID_UCT},
    ...
    // range of ments params
    {
        ...
        {ALG_PARAM_ID_INIT_TEMP,        0.00001},
    ...
    {
        {XPR_OR_ALG_ID_TAG,             ALG_ID_MENTS},
        {ALG_PARAM_ID_INIT_TEMP,        0.00003},
        {ALG_PARAM_ID_TEMP_DECAY_RATE,  0.0},
        {ALG_PARAM_ID_EPSILON,          0.0},
        {ALG_PARAM_ID_HEURISTIC_VALUE,  1.0},
    },
    ...
    // range of dents params
    {
        ...
        {ALG_PARAM_ID_EPSILON,          0.0},
        {ALG_PARAM_ID_HEURISTIC_VALUE,  1.0},
        {ALG_PARAM_ID_INIT_ENTROPY_COEFF,       0.00001},
    ...
    },
    {
        ...
        {ALG_PARAM_ID_EPSILON,          0.0},
        {ALG_PARAM_ID_HEURISTIC_VALUE,  1.0},
        {ALG_PARAM_ID_INIT_ENTROPY_COEFF,       0.00003},
        {ALG_PARAM_ID_ENTROPY_COEFF_ZERO_AT,    100000.0},
    },
    {
        {XPR_OR_ALG_ID_TAG,             ALG_ID_DENTS},
        ...
        {ALG_PARAM_ID_EPSILON,          0.0},
        {ALG_PARAM_ID_HEURISTIC_VALUE,  1.0},
        {ALG_PARAM_ID_INIT_ENTROPY_COEFF,       0.0001},
        {ALG_PARAM_ID_ENTROPY_COEFF_ZERO_AT,    100000.0},
    },
    {
        {XPR_OR_ALG_ID_TAG,             ALG_ID_DENTS},
        ...
        {ALG_PARAM_ID_EPSILON,          0.0},
        {ALG_PARAM_ID_HEURISTIC_VALUE,  1.0},
        {ALG_PARAM_ID_INIT_ENTROPY_COEFF,       0.0003},
        {ALG_PARAM_ID_ENTROPY_COEFF_ZERO_AT,    100000.0},
    },
    {
        {XPR_OR_ALG_ID_TAG,             ALG_ID_DENTS},
