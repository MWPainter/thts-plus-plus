...
static const std::vector<ConfigMap> CONFIG_102 =
{
    // xpr params
    {
        {XPR_OR_ALG_ID_TAG,                     XPR_PARAMS_ID_TAG},
        {XPR_PARAM_ID_NAME,                     "102_supp_entropy_temp_10_vary"},
        ...
        {XPR_PARAM_ID_TERMINATION_BOUND,        5000.0},
