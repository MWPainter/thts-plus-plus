...
static const std::vector<HpoptConfigMap> HPOPT_CONFIG_330 =
{
    // xpr params
    {
        {XPR_OR_ALG_ID_TAG,                             HPOPT_PARAMS_ID_TAG},
        {XPR_PARAM_ID_NAME,                             "330_hpopt_frozen_lake_stoch_sparse"},
        ...
        {HPOPT_PARAM_ID_ESTIMATE_CONFIDENCE_THRESHOLD,  0.005},
