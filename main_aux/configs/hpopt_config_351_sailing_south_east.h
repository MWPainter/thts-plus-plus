...
static const std::vector<HpoptConfigMap> HPOPT_CONFIG_351 =
{
    // xpr params
    {
        {XPR_OR_ALG_ID_TAG,                             HPOPT_PARAMS_ID_TAG},
        {XPR_PARAM_ID_NAME,                             "351_hpopt_sailing_south_east"},
        ...
        {HPOPT_PARAM_ID_ESTIMATE_CONFIDENCE_THRESHOLD,  5.0},
    ...
    // rents params
    {
        ...
        {ALG_PARAM_ID_NORMALISE_Q,      std::make_pair(1,  1)},
    },
};
