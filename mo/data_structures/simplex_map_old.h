...
namespace thts {
     ...
     *      playlist
     * TODO long term: make these structs private data types inside the SimplexMapOld class
     * 
    ...
    */
    struct TN {
        ...
        TN(SimplexMapOld& simplex_map, int dim, int depth, std::shared_ptr<std::vector<std::shared_ptr<NGV>>> simplex_vertices);
    ...
    */
    class SimplexMapOld {
        ...
        public:
            ...
            */
            SimplexMapOld(int reward_dim, Eigen::ArrayXd default_val);
