#include "mo/data_structures/simplex_map_old.h"
...
namespace thts {
    ...
    */
    void LSE::insert(shared_ptr<NGV> v, shared_ptr<NGV> x0, shared_ptr<NGV> x1, double r, SimplexMapOld& simplex_map) 
    {
    ...
    */
     ...
     * 
    */
    TN::TN(SimplexMapOld& simplex_map, int dim, int depth, shared_ptr<vector<shared_ptr<NGV>>> simplex_vertices) :
    ...
    */
    ...
    SimplexMapOld::SimplexMapOld(int reward_dim, Eigen::ArrayXd default_val) :
        dim(reward_dim),
        root_node(),
    ...
    shared_ptr<LSE> SimplexMapOld::get_or_create_lse(shared_ptr<NGV> v0, shared_ptr<NGV> v1) 
    {
    ...
    void SimplexMapOld::register_vertices_with_lse(shared_ptr<NGV> v0, shared_ptr<NGV> v1, shared_ptr<LSE> edge) 
    {
        UnorderedNGVPair lse_map_key = UnorderedNGVPair(v0,v1);
        lse_map[lse_map_key] = edge;
    }

    shared_ptr<TN> SimplexMapOld::get_leaf_tn_node(const Eigen::ArrayXd& ctx) const 
    {
    ...
    shared_ptr<TN> SimplexMapOld::operator[](const Eigen::ArrayXd& ctx) const
    {
        return get_leaf_tn_node(ctx);
    }

    shared_ptr<NGV> SimplexMapOld::sample_random_ngv_vertex(RandManager& rand_manager) const
    {
     ...
     * Prett print
    */
    std::string SimplexMapOld::get_pretty_print_string() const
    {
        stringstream ss;
     ...
     */
    ConvexHull SimplexMapOld::get_approximate_convex_hull() const 
    {
