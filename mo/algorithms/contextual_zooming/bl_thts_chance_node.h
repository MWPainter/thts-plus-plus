...
namespace thts {
    ...
    */
    class BlThtsCNode : public MoThtsCNode {
        friend BlThtsDNode;
        ...
        public:
            BlThtsCNode(
                ...
                std::shared_ptr<const BlThtsDNode> parent=nullptr); 

            virtual ~BlThtsCNode() = default;
        ...
        protected:
            virtual std::shared_ptr<BlThtsDNode> create_child_node_helper(
         ...
         */
        public:
            std::shared_ptr<BlThtsDNode> create_child_node(std::shared_ptr<const State> next_state);
            std::shared_ptr<BlThtsDNode> get_child_node(std::shared_ptr<const State> next_state) const;
