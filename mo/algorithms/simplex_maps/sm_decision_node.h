...
namespace thts {
    ...
    */
    class SmThtsDNode : public MoThtsDNode {
        friend SmThtsCNode;
        ...
        public:
            SmThtsDNode(
                ...
                std::shared_ptr<const SmThtsCNode> parent=nullptr); 

            virtual ~SmThtsDNode() = default;
         ...
         */
        public:
            std::shared_ptr<SmThtsCNode> create_child_node(std::shared_ptr<const Action> action);
            std::shared_ptr<SmThtsCNode> get_child_node(std::shared_ptr<const Action> action) const;
