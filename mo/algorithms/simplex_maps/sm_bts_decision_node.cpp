...
namespace thts {
        ...
        double& entropy_estimate_) const
    {
        ...
        value_estimate_local_ = closest_vertex->value_estimate_local;
    ...
    void SmBtsDNode::fill_child_values_maps_(
        ...
        unordered_map<shared_ptr<const Action>,Vec>& value_estimate_local_map_,
        unordered_map<shared_ptr<const Action>,double>& entropy_estimate_map_) const
    {
        ...
        for (shared_ptr<const Action> action : actions) 
        {
            ...
            value_estimate_local_map_.emplace(action, Vec::Const(dim, manager.default_q_utility));
            ...
            if (has_child_node_itfc(action)) 
            {
                this->read_values_from_child_(
                    ...
                    value_estimate_local_map_.at(action),
    ...
    */
    ...
    { 
        ...
        unordered_map<shared_ptr<const Action>,Vec> _q_vals_local_;
