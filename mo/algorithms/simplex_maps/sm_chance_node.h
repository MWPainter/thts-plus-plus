...
namespace thts {
    ...
    */
    class SmThtsCNode : public MoThtsCNode {
        friend SmThtsDNode;
        ...
        public:
            SmThtsCNode(
                std::shared_ptr<SmThtsManager> thts_manager,
                std::shared_ptr<const State> state,
                std::shared_ptr<const Action> action,
                int decision_depth,
                int decision_timestep,
                std::shared_ptr<const SmThtsDNode> parent=nullptr); 

            virtual ~SmThtsCNode() = default;
         ...
         */
        public:
            std::shared_ptr<SmThtsDNode> create_child_node(std::shared_ptr<const State> next_state);
            std::shared_ptr<SmThtsDNode> get_child_node(std::shared_ptr<const State> next_state) const;
