...
namespace thts {
    // forward declare 
    class ChParetoUctCNode;
    class ChParetoUctManager;
    class MoThtsContext;
    ...
    */
    class ChParetoUctDNode : public ChUctDNode {
        friend ChParetoUctCNode;
        ...
        public:
            ChParetoUctDNode(
                ...
                std::shared_ptr<const ChParetoUctCNode> parent=nullptr); 

            virtual ~ChParetoUctDNode() = default;
         ...
         */
        public:
            // std::shared_ptr<ChParetoUctCNode> create_child_node(std::shared_ptr<const Action> action);
            virtual std::shared_ptr<ChThtsCNode> create_child_node_helper(
                std::shared_ptr<const Action> action) const override;
            // std::shared_ptr<ChParetoUctCNode> get_child_node(std::shared_ptr<const Action> action) const;
