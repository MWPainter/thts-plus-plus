...
namespace thts {
    ...
    */
    class ChHvUctCNode : public ChUctCNode {
        friend ChHvUctDNode;
        ...
        public:
            ChHvUctCNode(
                ...
                std::shared_ptr<const ChHvUctDNode> parent=nullptr); 

            virtual ~ChHvUctCNode() = default;
         ...
         */
        public:
            // std::shared_ptr<ChHvUctDNode> create_child_node(std::shared_ptr<const State> next_state);
            virtual std::shared_ptr<ChThtsDNode> create_child_node_helper(
                std::shared_ptr<const State> next_state) const override;
            // std::shared_ptr<ChHvUctDNode> get_child_node(std::shared_ptr<const State> next_state) const;
