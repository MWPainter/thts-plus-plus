...
namespace thts {
    ...
    */
    class ChThtsDNode : public MoThtsDNode {
        friend ChThtsCNode;
        ...
        public:
            ChThtsDNode(
                ...
                std::shared_ptr<const ChThtsCNode> parent=nullptr); 

            virtual ~ChThtsDNode() = default;
         ...
         */
        public:
            std::shared_ptr<ChThtsCNode> create_child_node(std::shared_ptr<const Action> action);
            std::shared_ptr<ChThtsCNode> get_child_node(std::shared_ptr<const Action> action) const;
