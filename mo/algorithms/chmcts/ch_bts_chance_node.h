...
namespace thts {
    ...
    */
    class ChBtsCNode : public ChThtsCNode {
        friend ChBtsDNode;
        ...
        public:
            ChBtsCNode(
                ...
                std::shared_ptr<const ChBtsDNode> parent=nullptr); 

            virtual ~ChBtsCNode() = default;
         ...
         */
        public:
            std::shared_ptr<ChBtsDNode> create_child_node(std::shared_ptr<const State> next_state);
            virtual std::shared_ptr<ChThtsDNode> create_child_node_helper(
                std::shared_ptr<const State> next_state) const override;
            std::shared_ptr<ChBtsDNode> get_child_node(std::shared_ptr<const State> next_state) const;
