...
namespace thts {
    ...
    */
    class ChCztDNode : public ChThtsDNode {
        friend ChCztCNode;
        ...
        public:
            ChCztDNode(
                ...
                std::shared_ptr<const ChCztCNode> parent=nullptr); 

            virtual ~ChCztDNode() = default;
         ...
         */
        public:
            std::shared_ptr<ChCztCNode> create_child_node(std::shared_ptr<const Action> action);
            virtual std::shared_ptr<ChThtsCNode> create_child_node_helper(
                std::shared_ptr<const Action> action) const override;
            std::shared_ptr<ChCztCNode> get_child_node(std::shared_ptr<const Action> action) const;
