...
namespace thts {
    ...
    */
    class ChUctDNode : public ChThtsDNode {
        friend ChUctCNode;
        ...
        public:
            ChUctDNode(
                std::shared_ptr<ChUctManager> thts_manager,
                std::shared_ptr<const State> state,
                int decision_depth,
                int decision_timestep,
                std::shared_ptr<const ChUctCNode> parent=nullptr); 

            virtual ~ChUctDNode() = default;
        ...
        protected:
            ...
            virtual void fill_ucb_q_values(ActionDistr& ucb_q_values, MoThtsContext& ctx) const;
         ...
         */
        public:
            std::shared_ptr<ChUctCNode> create_child_node(std::shared_ptr<const Action> action);
            virtual std::shared_ptr<ChThtsCNode> create_child_node_helper(
                std::shared_ptr<const Action> action) const override;
            std::shared_ptr<ChUctCNode> get_child_node(std::shared_ptr<const Action> action) const;
