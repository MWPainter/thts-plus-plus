...
namespace thts {
    ...
    */
    class ChUctCNode : public ChThtsCNode {
        friend ChUctDNode;
        ...
        public:
            ChUctCNode(
                ...
                std::shared_ptr<const ChUctDNode> parent=nullptr); 

            virtual ~ChUctCNode() = default;
         ...
         */
        public:
            std::shared_ptr<ChUctDNode> create_child_node(std::shared_ptr<const State> next_state);
            virtual std::shared_ptr<ChThtsDNode> create_child_node_helper(
                std::shared_ptr<const State> next_state) const override;
            std::shared_ptr<ChUctDNode> get_child_node(std::shared_ptr<const State> next_state) const;
